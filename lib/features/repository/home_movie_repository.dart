...
//       debugPrint(
//           "${request.url.host}/${request.url.path}/${request.url.query}");
//       return request;
//     });
//   }
...
//       Decoder<T>? decoder}) {
//     Map<String, dynamic>? parsedQuery = query?.map(
...
//         return response
//             .body; //Future<MovieWrapper>.error(response.statusText!);
//       } else {
...
//       return MovieWrapper(
//           page: 0, totalResults: 0, totalPages: 0, results: <Movie>[]);
//     }
//   }
